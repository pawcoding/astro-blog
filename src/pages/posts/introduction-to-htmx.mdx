...
<Image src={multiPageApplication} alt="Multi Page Application" decoding="async" loading="lazy" style="width: 50%; margin: 0 auto 0 auto;" widths={[176, 368, multiPageApplication.width]} />
...
<Image src={singlePageApplication} alt="Single Page Application" decoding="async" loading="lazy" style="width: 50%; margin: 0 auto 0 auto;" widths={[176, 368, singlePageApplication.width]} />
...
<Image src={hybridApplication} alt="Hybrid Application" decoding="async" loading="lazy" style="width: 50%; margin: 0 auto 0 auto;" widths={[176, 368, hybridApplication.width]} />
...
<Image src={htmxApplication} alt="HTMX Application" decoding="async" loading="lazy" style="width: 50%; margin: 0 auto 0 auto;" widths={[176, 368, htmxApplication.width]} />
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        <Image src={bun} alt="Bun" decoding="async" loading="lazy" style="width: calc(100vw / 4); max-width: 150px" widths={[150, bun.width]} />
      </td>
      <td>
        <Image src={elysia} alt="Elysia" decoding="async" loading="lazy" style="width: calc(100vw / 4); max-width: 150px" widths={[150, elysia.width]} />
      </td>
      <td>
        <Image src={daisyui} alt="DaisyUI" decoding="async" loading="lazy" style="width: calc(100vw / 4); max-width: 150px" widths={[150, daisyui.width]} />
      </td>
      <td>
        <Image src={htmx} alt="HTMX" decoding="async" loading="lazy" style="width: calc(100vw / 4); max-width: 150px" widths={[150, htmx.width]} />
      </td>
    </tr>
  </tbody>
</table>
...
<Image src={lazyLoading} alt="Lazy loaded link creation form" decoding="async" loading="lazy" widths={[352, 736, lazyLoading.width]} />
...
<Image src={createdLinkCards} alt="Created link cards" decoding="async" loading="lazy" widths={[352, 736, createdLinkCards.width]} />
...
<Image src={listOfLinks} alt="List of links" decoding="async" loading="lazy" widths={[352, 736, listOfLinks.width]} />
...
<Image src={architectureDiagram} alt="Architecture diagram" decoding="async" loading="lazy" style="width: 75%; margin: 0 auto 0 auto;" widths={[264, 552, architectureDiagram.width]} />
