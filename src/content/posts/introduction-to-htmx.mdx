...
<Image
  ...
  alt="Multi Page Application"
  decoding="async"
  loading="eager"
  style="width: 50%; margin: 0 auto 0 auto;"
  widths={[176, 368, multiPageApplication.width]}
/>
...
<Image
  ...
  loading="lazy"
  style="width: 50%; margin: 0 auto 0 auto;"
  widths={[176, 368, singlePageApplication.width]}
/>
...
<Image
  ...
  loading="lazy"
  style="width: 50%; margin: 0 auto 0 auto;"
  widths={[176, 368, hybridApplication.width]}
/>
...
<Image
  src={htmxApplication}
  alt="HTMX Application"
  decoding="async"
  loading="lazy"
  style="width: 50%; margin: 0 auto 0 auto;"
  widths={[176, 368, htmxApplication.width]}
/>
...
<Image
  src={lazyLoading}
  alt="Lazy loaded link creation form"
  decoding="async"
  loading="lazy"
  widths={[352, 736, lazyLoading.width]}
/>
...
<Image
  ...
  alt="Created link cards"
  decoding="async"
  loading="lazy"
  widths={[352, 736, createdLinkCards.width]}
/>
...
<Image
  ...
  decoding="async"
  loading="lazy"
  widths={[352, 736, listOfLinks.width]}
/>
...
<Image
  ...
  widths={[264, 552, architectureDiagram.width]}
/>
