...
<Image
  src={homepage}
  alt='Screenshot of the homepage of the "Forum für Antike und Gesellschaft"'
  decoding="async"
  loading="eager"
  widths={[352, 736, homepage.width]}
/>
...
<div class="grid grid-cols-1 gap-4 xs:grid-cols-2">
  <Image
    src={podcast}
    alt="Screenshot of an available podcast"
    decoding="async"
    loading="lazy"
    style="margin: 0 auto 0 auto;"
    widths={[176, 360, podcast.width]}
  />
  <Image
    src={worksheets}
    alt="Screenshot of the worksheets for the podcast"
    decoding="async"
    loading="lazy"
    style="margin: 0 auto 0 auto;"
    widths={[176, 360, worksheets.width]}
  />
</div>
...
With this setup, the website keeps always running and restarts automatically if it crashes or I update the code (more on that in a future post).
...
<Image
  src={pm2Processes}
  alt="List of processes managed by PM2"
  decoding="async"
  loading="lazy"
  widths={[352, 736, pm2Processes.width]}
/>
...
<Image
  src={pocketbase}
  alt="Table of video material in PocketBase"
  decoding="async"
  loading="lazy"
  widths={[352, 736, pocketbase.width]}
/>
...
<Image
  src={fileUpload}
  alt="File upload dashboard for the authors"
  decoding="async"
  loading="lazy"
  widths={[352, 736, fileUpload.width]}
/>
...
<Image
  src={architecture}
  alt="Software running on the server"
  decoding="async"
  loading="lazy"
  widths={[352, 736, architecture.width]}
  class="!shadow-none"
/>
...
<Image
  src={flowVisitMiss}
  alt="Traffic flow when the requested page is not in the cache"
  decoding="async"
  loading="lazy"
  widths={[352, 736, architecture.width]}
  class="!shadow-none"
...
<Image
  src={flowVisitHit}
  alt="Traffic flow when the requested page is in the cache"
  decoding="async"
  loading="lazy"
  widths={[176, 368, architecture.width]}
...
<Image
  src={flowVisitDev}
  alt="Traffic flow when an author visits the development instance"
  decoding="async"
  loading="lazy"
  widths={[299, 626, architecture.width]}
...
<Image
  src={flowDownload}
  alt="Traffic flow when a user downloads a pdf worksheet"
  decoding="async"
  loading="lazy"
  widths={[176, 368, architecture.width]}
  style="width: 50%; margin: 0 auto 0 auto;"
...
<Image
  src={flowMediaStream}
  alt="Traffic flow when a user watches a video or listens to a podcast"
  decoding="async"
  loading="lazy"
  widths={[176, 368, architecture.width]}
  style="width: 50%; margin: 0 auto 0 auto;"
...
<Image
  src={flowMediaUpload}
  alt="Traffic flow when an author uploads a new video or podcast"
  decoding="async"
  loading="lazy"
  widths={[352, 736, architecture.width]}
  class="!shadow-none"
